...
# Designed for: 16GB RAM / 4 vCPU with AGE, TimescaleDB, and pgvecto.rs
...
# =============================================================================
shared_preload_libraries = 'age,timescaledb,vectors'
search_path = 'ag_catalog, "\$user", public, vectors'
...
# =============================================================================
# VectorChord / pgvecto.rs Settings
# Docs: https://docs.vectorchord.ai/vectorchord/
# =============================================================================
# probes: number of lists to scan (recommend 3-10% of total lists)
vchordrq.probes = '${VCHORDRQ_PROBES:-10}'
# epsilon: reranking precision (range 1.0-1.9, default 1.9; lower = faster, slightly less recall)
vchordrq.epsilon = ${VCHORDRQ_EPSILON:-1.9}
EOF
